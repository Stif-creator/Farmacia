        ...
        <div class="card p-4 shadow-sm auth-card">
            <div class="d-flex align-items-center mb-3 gap-3">
                ...
                <div>
                    ...
                    <p class="text-secondary mb-0">Agrega un nuevo usuario cliente o administrador.</p>
                </div>
            </div>
            <?php if ($mensaje): ?>
            ...
            <form action="guardar_usuario.php" method="post" novalidate>
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-farmacia"><i class="bi bi-save me-1"></i>Guardar usuario</button>
