        ...
        <div class="container py-5">
            <div class="row gy-4">
                ...
                <div class="col-md-3">
                    ...
                    <p class="text-muted small mb-2"><i class="bi bi-envelope-fill me-2"></i>admin@farmacia.com</p>
                ...
                <?php if (isset($_SESSION['usuario'])): ?>
                    <div class="col-md-3">
                        ...
                        <div class="d-flex gap-3 mb-3">
                            ...
                            <a href="mailto:admin@farmacia.com" class="text-white social-icon"><i class="bi bi-envelope"></i></a>
                        </div>
